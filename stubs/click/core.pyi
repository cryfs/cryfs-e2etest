...
class Context:
    ...
    def invoke(
        self, callback: Union['Command', Callable[..., Any]], *args: Any, **kwargs: Any
    ) -> Any:
        ...
...
class BaseCommand:
    ...
    def make_context(
        self, info_name: Text, args: List[Text], parent: Optional[Context] = ..., **extra: Any
    ) -> Context:
        ...
...
class Group(MultiCommand):
    ...
    def __init__(
        self, name: Optional[Text] = ..., commands: Optional[Dict[Text, Command]] = ..., **attrs: Any
    ) -> None:
        ...

    def add_command(self, cmd: Command, name: Optional[Text] = ...) -> Any:
        ...

    def command(self, *args: Any, **kwargs: Any) -> _Decorator[Any]:
        ...

    def group(self, *args: Any, **kwargs: Any) -> _Decorator[Any]:
        ...
...
class CommandCollection(MultiCommand):
    ...
    def __init__(
        self, name: Optional[Text] = ..., sources: Optional[List[MultiCommand]] = ..., **attrs: Any
    ) -> None:
        ...
